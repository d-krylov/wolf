...
enum class RenderPassCreateMaskBits : VkRenderPassCreateFlags {
...
enum class ImageViewCreateMaskBits : VkImageViewCreateFlags {
...
enum class SamplerCreateMaskBits : VkSamplerCreateFlags {
...
enum class SemaphoreCreateMaskBits : VkSemaphoreCreateFlags {
};
...
enum class MemoryMapMaskBits : VkMemoryMapFlags {
  E_PLACED_BIT_EXT = VK_MEMORY_MAP_PLACED_BIT_EXT,
};
...
enum class PrivateDataSlotCreateMaskBits : VkPrivateDataSlotCreateFlags {
};
...
enum class SwapchainCreateMaskBits : VkSwapchainCreateFlagsKHR {
...
enum class SubpassDescriptionMaskBits : VkSubpassDescriptionFlags {
...
enum class AcquireProfilingLockMaskBits : VkAcquireProfilingLockFlagsKHR {
};

enum class ShaderCorePropertiesMaskBits : VkShaderCorePropertiesFlagsAMD {
};
...
enum class ShaderModuleCreateMaskBits : VkShaderModuleCreateFlags {
};

enum class PipelineCompilerControlMaskBits : VkPipelineCompilerControlFlagsAMD {
};
...
enum class PipelineLayoutCreateMaskBits : VkPipelineLayoutCreateFlags {
...
enum class PipelineColorBlendStateCreateMaskBits : VkPipelineColorBlendStateCreateFlags {
...
enum class PipelineDepthStencilStateCreateMaskBits : VkPipelineDepthStencilStateCreateFlags {
...
enum class VideoEncodeMaskBits : VkVideoEncodeFlagsKHR {
};
...
enum class InstanceCreateMaskBits : VkInstanceCreateFlags {
...
enum class MemoryUnmapMaskBits : VkMemoryUnmapFlagsKHR {
  E_RESERVE_BIT_EXT = VK_MEMORY_UNMAP_RESERVE_BIT_EXT,
};
